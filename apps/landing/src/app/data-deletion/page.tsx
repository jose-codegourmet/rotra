import { DataDeletionContent } from "@rotra/legal-content";
...
export const metadata: Metadata = {
	title: "Data Deletion — ROTRA",
	description:
		"How to request deletion of your ROTRA account and associated personal data.",
};
