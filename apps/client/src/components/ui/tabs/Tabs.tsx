...
>(({ className, ...props }, ref) => (
	<TabsPrimitive.Trigger
		ref={ref}
		className={cn(
			"inline-flex items-center justify-center whitespace-nowrap rounded-md px-4 py-2 text-label font-bold uppercase tracking-widest transition-colors duration-default",
