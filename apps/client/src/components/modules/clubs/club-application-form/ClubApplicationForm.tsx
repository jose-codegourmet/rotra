...
export type ClubApplicationFormProps = {
	...
	disabled?: boolean;
	onValidatedSubmit: (body: ClubApplicationCreateFormValues) => void;
};
	...
	return (
		...
		>
			<Field data-invalid={!!formState.errors.clubName}>
				<FieldLabel htmlFor="club-application-club-name">Club name</FieldLabel>
				<FieldContent>
					<Input
			...
			<div className="pt-2">
				<Button
					...
					disabled={disabled}
					onClick={() =>
						void handleSubmit((values) => onValidatedSubmit(values))()
					}
				>
