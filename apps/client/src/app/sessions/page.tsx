        ...
        {SESSIONS.length > 0 ? (
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-small text-text-disabled ml-auto">{session.club}</span>
                  </div>

                  {/* Date + venue */}
                  <div>
                    <p className="text-heading font-semibold text-text-primary">{session.date}</p>
                  ...
                  {!isCompleted ? (
                    ...
                    <div className="flex items-center justify-between">
                      <span className="text-small text-text-secondary">
                        {session.total} players · {(session as typeof session & { matchesPlayed?: number }).matchesPlayed} matches played
                      </span>
                      <button
                        type="button"
          ...
          <div className="flex flex-col items-center justify-center py-20 gap-4">
            ...
            <div className="text-center">
              <p className="text-heading font-semibold text-text-primary">No sessions yet</p>
