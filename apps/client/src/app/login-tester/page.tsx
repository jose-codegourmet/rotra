...
import { LoginTesterCard } from "@/components/modules/auth/auth-page/login-tester-card/LoginTesterCard";
import DarkVeil from "@/components/ui/dark-veil/DarkVeil";
import { Logo } from "@/components/ui/logo/Logo";

export const metadata: Metadata = {
	title: "Tester Login — ROTRA",
	robots: { index: false, follow: false },
};

export default function LoginTesterPage() {
	return (
