import { Bell, ChevronRight, Link, Lock, Shield, Trash2, Users } from 'lucide-react'
...
const SETTINGS_SECTIONS = [
  {
    title: 'General',
    items: [
      { icon: Shield, label: 'Club Details', description: 'Name, location, description', href: '#' },
      { icon: Lock, label: 'Privacy & Visibility', description: 'Public or private club', href: '#' },
    ],
  },
  {
    title: 'Membership',
    items: [
      { icon: Users, label: 'Member Management', description: 'Approve, remove, and manage roles', href: '#' },
      { icon: Lock, label: 'Join Requests', description: 'Auto-approve or manual review', href: '#' },
      { icon: Link, label: 'Invite Links', description: 'Create and manage invite links', href: '#' },
    ],
  },
  {
    title: 'Notifications',
    items: [
      { icon: Bell, label: 'Club Notifications', description: 'Session alerts and announcements', href: '#' },
    ],
  },
]
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="bg-bg-surface border border-border rounded-lg p-5 shadow-card flex flex-col gap-4">
            <div className="flex items-center justify-between gap-4">
              <div>
                <p className="text-body font-medium text-text-primary">Dissolve Club</p>
