    ...
    <div className="max-w-[1100px] mx-auto p-4 md:p-8">
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_380px] gap-8">
        ...
        <div className="flex flex-col gap-6">
          ...
          {/* Description */}
          <p className="text-body text-text-secondary leading-relaxed">{club.description}</p>
              ...
              club.upcomingSessions.map((session) => (
                ...
                >
                  <div className="flex flex-col gap-1">
                    <p className="text-body font-semibold text-text-primary">{session.date}</p>
          ...
          <div className="flex items-center gap-2 text-small text-text-secondary pt-2">
            ...
            <span>
              Owned by{' '}
              <span className="text-text-primary font-medium">{club.owner.name}</span>
            </span>
          </div>
        </div>
