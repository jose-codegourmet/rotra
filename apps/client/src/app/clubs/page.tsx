import { CalendarClock, ChevronRight, MapPin, Plus, Trophy, Users } from 'lucide-react'
    ...
    <div className="max-w-[1400px] mx-auto p-4 md:p-8">
      <div className="flex flex-col gap-6">
        ...
        {MY_CLUBS.length > 0 ? (
          ...
          <div className="flex flex-col items-center justify-center py-20 gap-4">
            ...
            <div className="text-center">
              <p className="text-heading font-semibold text-text-primary">No clubs yet</p>
        ...
        <div className="border-t border-border pt-4">
          ...
          >
            <div>
              <p className="text-body font-semibold text-text-primary">Discover more clubs</p>
              <p className="text-small text-text-secondary">Browse public clubs and request to join</p>
            </div>
            <ChevronRight size={18} strokeWidth={1.5} className="text-text-disabled shrink-0" />
          </a>
        </div>
      </div>
    </div>
