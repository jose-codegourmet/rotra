...
const MOCK_CLUBS = [
  {
    ...
    members: 24,
    description: 'Competitive-social club focused on doubles rotational play. Open to all levels.',
    founded: 'Jan 2024',
    status: 'member',
  },
  {
    ...
    location: 'Makati',
    members: 12,
    description: 'Casual social play for working professionals. Friendly atmosphere.',
    founded: 'Mar 2024',
    status: 'not-member',
  },
  {
    ...
    location: 'Pasig City',
    members: 38,
    description: 'Competitive club with weekly ranked sessions and monthly tournaments.',
    founded: 'Jun 2023',
    status: 'pending',
  },
  {
    ...
    location: 'Manila',
    members: 19,
    description: 'Mixed-level club with structured coaching and skill development sessions.',
    founded: 'Nov 2023',
    status: 'not-member',
  },
]
            ...
            >
              <div className="flex items-start justify-between gap-4">
                <div className="flex flex-col gap-1 flex-1 min-w-0">
                  ...
                  <p className="text-small text-text-disabled">Est. {club.founded}</p>
                </div>
