...
| Story fixtures from `src/constants/` | Many stories inline mocks; admin customer detail stories now import `@/constants/mock-customers` (#93 slice). Remaining still inlined. |
